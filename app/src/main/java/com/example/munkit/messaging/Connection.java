...
import com.example.munkit.messaging.internal.Persistence;
import com.example.munkit.messaging.internal.PersistenceException;
...
public class Connection {
    ...
    private static final String activityClass = "com.example.munkit.messaging.MainActivity";
    ...
    public final ArrayList<ReceivedMessage> messageHistory =  new ArrayList<ReceivedMessage>();
    ...
    public void messageArrived(String topic, MqttMessage message){
        ...
        if(subscriptions.containsKey(topic)){
            ...
            if(subscriptions.get(topic).isEnableNotifications()){
                ...
                //format string args : fromTopic@payload
                /*Object[] notifyArgs = new String[3];
                notifyArgs[0] = this.getId();
                notifyArgs[1] = new String(message.getPayload());
                notifyArgs[2] = topic;*/
                Object[] notifyArgs = new String[3];
                String[] tempstr = new String(message.getPayload()).split("@");
                notifyArgs[0] = tempstr[0]; //get fromtopic
                notifyArgs[1] = tempstr[1];
                notifyArgs[2] = topic;
                //notify the user
    ...
    public void addMessages(String Topic ,String newmsg){
        if (!Topic.equals("") && !newmsg.equals("")) {
            newmsg = "Me@" + newmsg;
            byte[] array = newmsg.getBytes();
            ReceivedMessage newmessage = new ReceivedMessage(Topic, new MqttMessage(array));
            //ReceivedMessage msg = new ReceivedMessage(topic, message);
